...
class MMEvaluator(object):
    ...
    def extract_features(self, dataloader):
        ...
        """
        self.model_img = self.model.img_enc
        self.model_txt = self.model.txt_enc
        self.model_img.eval()
        self.model_txt.eval()
        self.model_img.to(self.extract_device)
        self.model_txt.to(self.extract_device)

        num_images = dataloader.dataset.num_rows
        ...
        for data in self.pbar(dataloader):
            images = data["processed_img"].to(self.extract_device)
    ...
    def evaluate(self, dataloader, n_crossfolds=None,
                 n_images_per_crossfold=10,
                 n_captions_per_crossfold=10,
