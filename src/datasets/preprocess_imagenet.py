...
# 配置参数
# ============================================
OUTPUT_DIR = Path("preprocessed_imagenet/domain_datasets")
...
# ============================================
logger.info("=" * 70)
logger.info("Step 2: Loading CLIP RN50 model")
logger.info("=" * 70)
...
def process_and_encode_example(example, domain_idx, class_id):
    ...
    try:
        ...
        # 处理文本
        text_tokens = tokenizer(example["recaption_short"], truncate=True).to(DEVICE)
