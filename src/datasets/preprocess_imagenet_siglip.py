...
# 配置参数
# ============================================
OUTPUT_DIR = Path("preprocessed_imagenet/domain_datasets/siglip")
...
# ============================================
logger.info("=" * 70)
logger.info("Step 2: Loading SigLIP model from HuggingFace")
logger.info("=" * 70)
