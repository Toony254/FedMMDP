...
def args():
    ...
    parser.add_argument('--mu', type=int, default=0.01, help='coefficient of mu')
    parser.add_argument('--con', type=int, default=1.0, help='coefficient of con')
    ...
    parser.add_argument('--FL_algorithm', type=str, default='MASA',
                        choices=['MASA', 'FedAvg', 'FedProx', 'FedMD', 'MOON', 'FedDF', 'Harmony', 'Cream', 'RawCLIP'],
    ...
    parser.add_argument('--num_relays', type=float, default=5)
    parser.add_argument('--num_clusters', type=float, default=5)
    parser.add_argument('--max_ssm_components', type=float, default=5)
...
if __name__ == "__main__":
    ...
    if args.FL_algorithm == 'MASA':
        from algorithms.MASA import MMFL
    elif args.FL_algorithm == 'FedAvg':
        from algorithms.FedAvg import MMFL
    elif args.FL_algorithm == 'FedProx':
        from algorithms.FedProx import MMFL
    elif args.FL_algorithm == 'FedMD':
