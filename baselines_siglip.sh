...
CUDA_VISIBLE_DEVICES=3 python src/main.py --name FedMMDP --FL_algorithm FedMMDP --dataset iapr --data_root "$IMAGENET_SIGLIP_ROOT" --lr 1e-5 --local_epochs 1 --comm_rounds 20 --model clip --batch_size 256 >outputs/output_FedMMDP.log 2>&1 &